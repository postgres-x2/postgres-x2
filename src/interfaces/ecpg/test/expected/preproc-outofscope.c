...
#line 24 "outofscope.pgc"
 ...
 /* declare mycur cursor for select * from a1 order by 1 , 2 , 3 , 4 , 5 */
...
open_cur1(void)
{
	{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "declare mycur cursor for select * from a1 order by 1 , 2 , 3 , 4 , 5", ECPGt_EOIT, 
